...
function Get-EolInfo {
    param (
        [Parameter(Mandatory = $true)]
        [ValidateSet("akeneo-pim","alibaba-ack","alibaba-dragonwell","almalinux","alpine-linux","amazon-cdk","amazon-corretto","amazon-eks","amazon-glue","amazon-linux","amazon-msk","amazon-neptune","amazon-rds-mariadb","amazon-rds-mysql","amazon-rds-postgresql","android","angular","angularjs","ansible","ansible-core","ant","antix","apache-activemq","apache-airflow","apache-apisix","apache-camel","apache-cassandra","apache-couchdb","apache-flink","apache-groovy","apache-hadoop","apache-hop","apache-http-server","apache-kafka","apache-lucene","apache-maven","apache-nifi","apache-pulsar","apache-spark","apache-struts","apache-subversion","api-platform","apple-watch","arangodb","argo-cd","artifactory","aws-lambda","azul-zulu","azure-devops-server","azure-kubernetes-service","backdrop","bamboo","bazel","beats","behat","bellsoft-liberica","big-ip","bigbluebutton","bitbucket","blender","bootstrap","bun","caddy","cakephp","calico","centos","centos-stream","centreon","cert-manager","cfengine","chef-infra-client","chef-infra-server","chef-inspec","chef-supermarket","chrome","citrix-vad","ckeditor","clamav","clear-linux","cnspec","cockroachdb","coder","coldfusion","composer","confluence","consul","containerd","contao","contour","controlm","cortex-xdr","cos","couchbase-server","craft-cms","dbt-core","dce","debian","deno","dependency-track","devuan","django","docker-engine","dotnet","dotnetfx","drupal","drush","eclipse-jetty","eclipse-temurin","elasticsearch","electron","elixir","emberjs","envoy","erlang","eslint","esxi","etcd","eurolinux","exim","express","fairphone","fedora","ffmpeg","filemaker","firefox","fluent-bit","flux","font-awesome","forgejo","fortios","freebsd","gatekeeper","gerrit","ghc","gitlab","go","goaccess","godot","google-kubernetes-engine","google-nexus","gorilla","graalvm-ce","gradle","grafana","grafana-loki","grails","graylog","greenlight","grumphp","grunt","gstreamer","guzzle","haproxy","harbor","hashicorp-packer","hashicorp-vault","hbase","horizon","ibm-aix","ibm-i","ibm-semeru-runtime","icinga","icinga-web","intel-processors","internet-explorer","ionic","ios","ipad","ipados","iphone","isc-dhcp","istio","jekyll","jenkins","jhipster","jira-software","joomla","jquery","jquery-ui","jreleaser","julia","kde-plasma","keda","keycloak","kibana","kindle","kirby","kong-gateway","kotlin","kubernetes","kubernetes-csi-node-driver-registrar","kubernetes-node-feature-discovery","kuma","kyverno","laravel","ldap-account-manager","libreoffice","lineageos","linux","linuxmint","liquibase","log4j","logstash","looker","lua","macos","mageia","magento","mandrel","mariadb","mastodon","matomo","mattermost","mautic","mediawiki","meilisearch","memcached","micronaut","microsoft-build-of-openjdk","mongodb","moodle","motorola-mobility","msexchange","mssqlserver","mulesoft-runtime","mxlinux","mysql","neo4j","neos","netapp-ontap","netbsd","nextcloud","nextjs","nexus","nginx","nix","nixos","nodejs","nokia","nomad","notepad-plus-plus","numpy","nutanix-aos","nutanix-files","nutanix-prism","nuxt","nvidia","nvidia-gpu","nvm","office","oneplus","openbsd","openjdk-builds-from-oracle","opensearch","openssl","opensuse","opentofu","openvpn","openwrt","openzfs","opnsense","oracle-apex","oracle-database","oracle-graalvm","oracle-jdk","oracle-linux","oracle-solaris","ovirt","pangp","panos","pci-dss","perl","phoenix-framework","photon","php","phpbb","phpmyadmin","pixel","pixel-watch","plesk","plone","pnpm","podman","pop-os","postfix","postgresql","postmarketos","powershell","privatebin","proftpd","prometheus","protractor","proxmox-ve","puppet","python","qt","quarkus-framework","quasar","rabbitmq","rails","rancher","raspberry-pi","react","react-native","red-hat-openshift","redhat-build-of-openjdk","redhat-jboss-eap","redhat-satellite","redis","redmine","rhel","robo","rocket-chat","rocky-linux","ros","ros-2","roundcube","rtpengine","ruby","rust","salt","samsung-galaxy-tab","samsung-galaxy-watch","samsung-mobile","sapmachine","scala","sharepoint","shopware","silverstripe","slackware","sles","solr","sonar","sourcegraph","splunk","spring-boot","spring-framework","sqlite","squid","steamos","surface","suse-manager","svelte","symfony","tails","tarantool","tarteaucitron","telegraf","terraform","thumbor","tomcat","traefik","tvos","twig","typo3","ubuntu","umbraco","unity","unrealircd","valkey","varnish","vcenter","veeam-backup-and-replication","veeam-backup-for-microsoft-365","veeam-one","virtualbox","visionos","visual-cobol","visual-studio","vitess","vmware-cloud-foundation","vmware-harbor-registry","vmware-srm","vue","vuetify","wagtail","watchos","weakforced","weechat","windows","windows-embedded","windows-nano-server","windows-server","windows-server-core","wireshark","wordpress","xcp-ng","yarn","yocto","zabbix","zentyal","zerto","zookeeper")][string]$productName,
